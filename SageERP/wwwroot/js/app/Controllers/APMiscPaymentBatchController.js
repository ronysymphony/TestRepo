var APMiscPaymentBatchController = function () {
    ...
    var GlBatchTable = function () {
        ...
        var dataTable = $("#GLBatchLists").DataTable({
            ...
            ajax: {
                url: '/APMiscPaymentBatchList/_index',
                type: 'POST',
...
function editEntry(id, branchId, branchLegalName) {
    ...
    form.setAttribute("action", "/APMiscPayment/Index");
    ...
    //var branchId2 = $('#Branchs').val();
    //if (branchId2 == null || branchId2 === '') {
    //    var branchId2 = $('#CurrentBranchId').val();
    // }
    //var input = document.createElement("input");
    //input.setAttribute("type", "hidden");
    //input.setAttribute("name", "Code");
    //input.setAttribute("value", branchId2);
    //form.appendChild(input);
