var TransportSelfApproveStatusController = function (CommonService, TransportAllownacesService, TransportSelfApproveStatusService) {
    ...
    var TransportApproveStatusTable = function () {
        ...
        var dataTable = $("#ApproveStatusist").DataTable({
            ...
            ajax: {
                ...
                url: '/TransportAllownaces/_approveStatusIndex?status=' + Status,
                type: 'POST',
...
}(CommonService, TransportAllownacesService, TransportSelfApproveStatusService);