var TeamMembersController = function (TeamMembersService) {
    ...
    var TeamMembers = function () {
        ...
        $('#teamMembersLists thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#teamMembersLists thead');


        var dataTable = $("#teamMembersLists").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/TeamMembers/Edit/" + data + " class='edit' ><i class='editIcon' data-toggle='tooltip' title='' data-original-title='Edit'></i></a>   "
                            ;
                    },
                    "width": "7%",
                    "orderable": false
    ...
    function save() {
        ...
        var validator = $("#frm_teamMembers").validate();
        var userMembers = serializeInputs("frm_teamMembers");
        ...
        TeamMembersService.save(userMembers, saveDone, saveFail);
    }
