var APPBatchsController = function (CommonService, APPaymentsService) {
    ...
    function saveBatch() {
        ...
        APPaymentsService.saveBatch(glbatch, saveDone, saveFail);
    }
    ...
    var appBatchTable = function () {

        $('#appBatchLists thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#appBatchLists thead');


        var dataTable = $("#appBatchLists").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return "<a href=/APPaymentBatchList/Edit/" + data + " class='edit' ><i class='editIcon'title='Edit Batch' data-toggle='tooltip' title='' data-original-title='Edit'></i></a>&nbsp;&nbsp;&nbsp;" +
