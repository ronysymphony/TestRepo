var TourSelfApproveStatusController = function (CommonService, TourSelfApproveStatusService) {
    ...
    var ToursTable = function () {
        ...
        var dataTable = $("#ApproveStatusist").DataTable({
            ...
            ajax: {
                url: '/Tours/_approveStatusIndex?status=' + Status,
...
}(CommonService, TourSelfApproveStatusService);