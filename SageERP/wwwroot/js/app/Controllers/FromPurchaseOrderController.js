var FromPurchaseOrderController = function (CommonService, ModalService, FromPurchaseOrderService) {
    ...
    var init = function () {
        ...
        $('#ICReceiptData').on('click', function () {
    ...
    var POPurchaseOrderTable = function () {
        ...
        var dataTable = $("#POPurchaseOrdersLists").DataTable({
            ...
            ajax: {
                url: '/PurchaseOrder/_toPurchaseOrder',
                type: 'POST',
...
}(CommonService, ModalService, FromPurchaseOrderService);