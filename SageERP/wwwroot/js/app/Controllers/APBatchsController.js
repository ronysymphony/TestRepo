var APBatchsController = function (CommonService, APInvoiceService) {
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return "<a href=/APInvoiceBatchList/Edit/" + data + " class='edit' ><i class='editIcon'title='Edit Batch' data-toggle='tooltip' title='' data-original-title='Edit'></i></a>&nbsp;&nbsp;&nbsp;" +
                            ...
                            //"<a href='#' onclick='editEntry(\"" + row.sageBatchNo + "\",\"" + row.branchId + "\")' class='edit' title='Payments'><i class='fas fa-file-invoice'></i></a>"
